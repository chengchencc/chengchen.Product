...
namespace SubSonic.Oracle.Repository
{
    ...
    public interface IRepository
    {
        ...
        T First<T>(Expression<Func<T, bool>> expression, Expression<Func<T, object>> orderBy, bool isDesc) where T : class, new();
        IList<T> Find<T>(Expression<Func<T, bool>> expression) where T : class, new();
        PagedList<T> GetPaged<T>(int pageIndex, int pageSize, Expression<Func<T, bool>> expression) where T : class, new();
        PagedList<T> GetPaged<T>(int pageIndex, int pageSize, Expression<Func<T, bool>> expression, Expression<Func<T, object>> orderBy, bool isDesc) where T : class, new();
        PagedList<T> GetPaged<T>(int pageIndex, int pageSize, Expression<Func<T, object>> orderBy, bool isDesc) where T : class, new();
        ...
        long NewAdd<T>(T item) where T : class ,new();
