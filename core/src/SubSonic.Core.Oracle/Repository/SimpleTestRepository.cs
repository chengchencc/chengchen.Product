    ...
    public class SimpleTestRepository : IRepository
    {
        ...
        private class ItemStorage<T> : ItemStorage
        {
            ...
            public int Add(T item)
            {
                ...
                return int.Parse(sequenceId.ToString());
            }
        ...
        public PagedList<T> GetPaged<T>(int pageIndex, int pageSize, Expression<Func<T, bool>> expression, Expression<Func<T, object>> property, bool isDesc) where T : class, new()
        {
            throw new NotImplementedException();
        }
