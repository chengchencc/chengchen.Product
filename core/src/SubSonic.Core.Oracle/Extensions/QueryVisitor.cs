...
{
    public class QueryVisitor : SubSonic.Oracle.Linq.Structure.ExpressionVisitor
    {
        private List<Constraint> constraints;
        private Constraint current;

        private bool isLeft;
        private bool isNot; // subsonic's to do: This is a quick fix - see VisitUnary
        ...
        {
            isNot = true;   // subsonic's to do: This is quick fix - Unary handling has to be reworked!
        ...
        {
            // subsonic's to do: Here we only support member expressions -> Extend to solve http://github.com/subsonic/SubSonic-3.0/issues#issue/59
